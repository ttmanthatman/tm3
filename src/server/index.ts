...
import { createMessageSerializationService } from "./services/messageSerialization.js";
...
const messageSerializationService = createMessageSerializationService({
  prisma,
  musicService,
...
const { serializeMessage, hydrateMessage, buildMessageSerializeBatch } = messageSerializationService;
