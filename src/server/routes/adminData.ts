  ...
  async function usersExportPayload() {
    ...
    return {
      ...
      accounts: accounts.map((account) => ({
        ...
        storyFeedReadAt: account.storyFeedReadAt,
        storyInteractionReadAt: account.storyInteractionReadAt,
        role: account.role,
    ...
    for (const item of accounts) {
      ...
      const account = await prisma.account.upsert({
        ...
        update: {
          ...
          ...(item.storyFeedReadAt ? { storyFeedReadAt: parseDate(item.storyFeedReadAt) } : {}),
          ...(item.storyInteractionReadAt ? { storyInteractionReadAt: parseDate(item.storyInteractionReadAt) } : {}),
