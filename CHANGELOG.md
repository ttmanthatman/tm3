...
- 乡野河谷十层卷轴背景随消息阅读方向横向移动，可在外观设置中选择套件并设置相对移动速度。
- 修复测试站更新检测的版本碰撞：后续测试分支发布使用 `0.10.4`，使更新器能识别高于已运行 `0.10.3` 的版本。

## 0.10.3 - 2026-07-11

- 外观设置新增独立“卷轴背景”栏目，可选择乡野河谷多层套件并设置 0.25×–3.00× 相对移动速度。
- 卷轴随消息上下阅读和新消息跟随横向移动，十层景色按远近使用不同速度。
- 第三方卷轴素材从本地 `storage/parallax` 读取，不进入 GPL 公共源码树。
